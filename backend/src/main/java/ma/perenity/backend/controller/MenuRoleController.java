...
public class MenuRoleController {
    ...
    public ResponseEntity<List<RoleDTO>> getRoles(@PathVariable Long menuId) {
        return ResponseEntity.ok(menuRoleService.getRolesForMenu(menuId));
    }

    @PostMapping("/{menuId}/roles/{roleId}")
    public ResponseEntity<Void> assignRole(@PathVariable Long menuId,
    ...
    public ResponseEntity<Void> removeRole(@PathVariable Long menuId,
                                           @PathVariable Long roleId) {
    ...
    public ResponseEntity<List<RoleDTO>> unassignedRoles() {

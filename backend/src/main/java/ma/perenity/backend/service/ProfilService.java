...
public interface ProfilService {
    ...
    void updateProjectPermissions(Long profilId, List<ProjectPermissionUpdateDTO> projPermissions);


    void updateAllPermissions(Long profilId, UpdateProfilPermissionsRequest request);
}